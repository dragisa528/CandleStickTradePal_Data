        ...
        <div className="app cursor-pointer">
            <div className='row'>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="row">
                                        <div className="col-6">
                                            ...
                                            <FormTag id="text-1" value={AAAO1} color="input_yellow" title="Portfolio Balance" onChange={handleAAAO1} onKeyPress={handleKeyPress} name="CIIO5" />
                                        </div>
                                        <div className="col-6">
                                            <FormTag id="text-2" onkeydown="focusNext(event, 'text-1')" value={AAAO2} color="input_yellow" title="Portfolio at Risk" val="%" onChange={handleAAAO2} onKeyPress={handleKeyPress} name="CIIO6" />
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-6">
                                            <FormTag value={CCCO1} color="input_red" title="My Risk Tolerance" val="$" onChange={handleCCCO1} onKeyPress={handleKeyPress} name="CIIO7" />
                                        </div>
                                        <div className="col-6">
                                            <FormTag value={CCCO2} color="input_green" title="Profit Goal " onChange={handleCCCO2} val="$" onKeyPress={handleKeyPress} name="CIIO8" />
                                        </div>
                                    </div>
                                    <div className="row mb-3">
                                        <div className="col-6">
                                            <FormTag value={MMMO1} val="m" color="input_white" title="Ticker Value" onChange={handleMMMO1} onKeyPress={handleKeyPress} name="CIIO9" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="col-sm-8 mb-1">
                    <div className="card">
                        <div className="card-body">
                            <h4 className="" style={{ color: "#CBCBE2" }}>Candlestick Simulator</h4>
                            <div className="row" style={{ marginTop: '0px' }}>
                                <div className="col-5 ">
                                    <div className="row mt-5 " style={{ marginBottom: '150px' }}>
                                        <div className="col-12">
                                            <FormTag4 value={GGGO1} color="input_white" title="Sell  Price" onChange={handleGGGO1} val="$" onKeyPress={handleKeyPress} name="CIIO1" />
                                        </div>
                                    </div>
                                    <div className="row" style={{ marginBottom: '80px' }}>
                                        <div className="col-12">
                                            <FormTag4 value={EEEO2} color="input_white" title="Position Size" onChange={handleEEEO2} val="m" onKeyPress={handleKeyPress} name="CIIO2" />
                                        </div>
                                    </div>
                                    <div className="row" style={{ marginBottom: '70px' }}>
                                        <div className="col-12">
                                            <FormTag4 value={EEEO1} color="input_white" title="Entry Price" onChange={handleEEEO1} val="$" onKeyPress={handleKeyPress} name="CIIO3" />
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-12">
                                            <FormTag4 value={EEEO3} color="input_white" title="Stop Price" onChange={handleEEEO3} onKeyPress={handleKeyPress} name="CIIO4" />
                                        </div>
                                    </div>
                                    <div className="row text-center">
                                        <div className="col-6">
                                ...
                                <div className="col-4 d-flex align-items-center flex-column">
                                    <div className="row mt-3 " style={{ marginBottom: '10px' }}>
                                        <div className="col-12">
                                            <FormTag4 value={Currency + " " + num.format(FO3.toFixed(2))} color="green" title="Optimum Sell Price" />
                                        </div>
                                    </div>
                                    <div className="row" style={{ marginBottom: '60px' }}>
                                        <div className="col-12">
                                            <FormTag4 value={Currency + " " + num.format(GO2.toFixed(2))} color="green" title="Projected Profit " />
                                        </div>
                                    </div>
                                    <div className="row" style={{ marginBottom: '50px' }}>
                                        <div className="col-12">
                                            <FormTag4 value={num.format(DO2.toFixed(2))} color="blue" title="Optimum Quantity" />
                                        </div>
                                    </div>
                                    <div className="row" style={{ marginBottom: '160px' }}>
                                        <div className="col-12">
                                            <FormTag4 value={Currency + " " + num.format(DO1.toFixed(2))} color="blue" title="Quantity Value" />
                                        </div>
                                    </div>
                                    <div className="row mb-5">
                                        <div className="col-12">
                                            <FormTag4 value={Currency + " " + num.format(FO2.toFixed(2))} color="red" title="Optimum Stop Price" />
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-12">
                                            <FormTag4 value={Currency + " " + num.format(FO1.toFixed(2))} color="red" title="Projected Loss" />
                                        </div>
                                    </div>
                                </div>
                            </div>
