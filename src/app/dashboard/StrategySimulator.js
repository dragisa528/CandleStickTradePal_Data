        ...
        <div className="col-sm-4">
            ...
            <div className='col-sm-12'>
              <div className="card" style={{ borderRadius: '8px' }}>
                <div className="card-body">
                  <h4 className='' style={{ color: "#CBCBE2" }}>Portfolio Strength</h4>
                  <div className="row text-center" >
                    <div className="col-sm-6">
                      <FormTag color="green" title="Portfolio Risk " value={Currency + " " + num.format(BO1.toFixed(2))} />
                    </div>
                    <div className="col-sm-6">
                      <FormTag color="green" title="Portfolio Quantity" value={num.format(BO2.toFixed(2))} />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className='row mb-1'>
            <div className='col-sm-12'>
              <div className="card" style={{ borderRadius: '8px' }}>
                <div className="card-body">
                  <h4 style={{ color: "#CBCBE2" }}>Portfolio Trade Management</h4>
                  <div className="row">
                    <div className="col-6">
                      <FormTag value={AAAO1} color="input_yellow" title="Portfolio Balance" val="$" onChange={handleAAAO1} onKeyPress={handleKeyPress} name="CIO1" />
                    </div>
                    <div className="col-6">
                      <FormTag onKeyPress={handleKeyPress} value={AAAO2} color="input_yellow" title="Portfolio at Risk" val="%" onChange={handleAAAO2} name="CIO2" />
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-6">
                      <FormTag value={CCCO1} onKeyPress={handleKeyPress} color="input_red" title="My Risk Tolerance" val="$" onChange={handleCCCO1} name="CIO3" />
                    </div>
                    <div className="col-6">
                      <FormTag value={CCCO2} onKeyPress={handleKeyPress} color="input_green" title="Profit Goal" onChange={handleCCCO2} val="$" name="CIO4" />
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-6">
                      <FormTag value={MMMO1} color="input_white" onChange={handleMMMO1} title="Ticker Value" val="m" onKeyPress={handleKeyPress} name="CIO5" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="col-sm-4">
          <div className='row mb-2'>
            <div className='col-sm-12'>
              <div className="card">
                <div className="card-body">
                  <h4 className='' style={{ color: "#CBCBE2" }}>Price Order Report</h4>
                  <div className="row mt-3 text-center">
                    ...
                    <div className="col-6 mb-4" >
                      <FormTag color="green" title="Take Profit" value={Currency + " " + num.format(FO3.toFixed(2))} />
                    </div>
                    <div className="col-6">
                    ...
                    <div className="col-6">
                      <FormTag color="green" title="Investment Return" value={(HO1 * 100).toFixed(0) + "%"} />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className='row mb-2'>
            <div className='col-sm-12'>
              <div className="card" style={{ borderRadius: '8px' }}>
                <div className="card-body">
                  <h4 style={{ color: "#CBCBE2" }}>Price Order Simulator</h4>
                  <div className="row mt-4">
                    <div className="col-6">
                      <FormTag max={100000} value={EEEO1} color="input_yellow" val="$" onChange={handleEEEO1} title="Entry Price" onKeyPress={handleKeyPress} name="CIO6" />
                    </div>
                    <div className="col-6">
                      <FormTag max={100000} value={EEEO2} color="input_blue" title="Position Size" onChange={handleEEEO2} val="m" onKeyPress={handleKeyPress} name="CIO7" />
                    </div>
                    <div className="col-6">
                      <FormTag max={100000} value={EEEO3} color="input_red" val="$" onChange={handleEEEO3} title="Stop Price" onKeyPress={handleKeyPress} name="CIO8" />
                    </div>
                    <div className="col-6">
                      <FormTag max={100000} value={GGGO1} color="input_green" val="$" title="Sell Price" onChange={handleGGGO1} onKeyPress={handleKeyPress} name="CIO9" />
                    </div>
                  </div>
        ...
        <div className="col-sm-4">
          <div className='row mb-2'>
            <div className='col-sm-12'>
              <div className="card">
                <div className="card-body">
                  <h4 className='F' style={{ color: "#CBCBE2" }}>Percentage Order Report</h4>
                  <div className="row mt-3 text-center">
                    <div className="col-4">
                      <FormTag1 color="red" title="Amount Invested" value={Currency + " " + num.format(HO2.toFixed(0))} />
                    </div>
                    <div className="col-4">
                      <FormTag1 color="blue" title="Ticker Value" value={num.format((MO1 * 1).toFixed(1))} />
                    </div>
                    ...
                    <div className="col-4">
                      <FormTag1 color="green" title="Take Profit" value={Currency + " " + num.format(KO2.toFixed(2))} />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className='row mb-2'>
            <div className='col-sm-12'>
              <div className="card" style={{ borderRadius: '8px' }}>
                <div className="card-body">
                  <h4 style={{ color: "#CBCBE2" }}>Percentage Order Simulator</h4>
                  <div className="row mt-3">
                    <div className="col-6">
                      <FormTag max={100000} value={EEEO1} color="input_yellow" val="$" title="Entry Price" onChange={handleEEEO1} onKeyPress={handleKeyPress} name="CIO10" />
                    </div>
                    <div className="col-6">
                      <FormTag max={100000} value={EEEO2} color="input_blue" title="Position Size" val="m" onChange={handleEEEO2} onKeyPress={handleKeyPress} name="CIO11" />
                    </div>
                    <div className="col-6">
                      <FormTag max={100000} value={IIIO1} color="input_red" val="%" title="Optimum Risk " onChange={handleIIIO1} onKeyPress={handleKeyPress} name="CIO12" />
                    </div>
                    <div className="col-6">
                      <FormTag max={100000} value={JJJO1} color="input_green" val="%" title="Profit Target " onChange={handleJJJO1} onKeyPress={handleKeyPress} name="CIO13" />
                    </div>
                  </div>
                  <div className="row mt-2 text-center">
                    <div className="col-6">
